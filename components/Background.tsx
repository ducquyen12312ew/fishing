  ...
  return (
    <div style={{ position: 'absolute', top, left: '-70px', animation: `butterflyFly ${duration}s linear ${delay}s infinite`, willChange: 'transform' }}>
      <div style={{ position: 'relative', width: 24, height: 16, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        {/* left wing */}
        <div style={{ position: 'absolute', left: 0, width: 12, height: 14, background: color, borderRadius: '60% 0 60% 40%', opacity: 0.85, animation: `butterflyWing ${0.25}s ease-in-out infinite`, transformOrigin: 'right center' }} />
        {/* right wing */}
        <div style={{ position: 'absolute', right: 0, width: 12, height: 14, background: color, borderRadius: '0 60% 40% 60%', opacity: 0.85, animation: `butterflyWing ${0.25}s ease-in-out ${0.125}s infinite`, transformOrigin: 'left center' }} />
        {/* body */}
...
export default function Background() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <img src="/background/bg1.png" alt="" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', imageRendering: 'pixelated' }} />
      ...
      <div style={{ position: 'absolute', bottom: 0, left: '-5%', right: '-5%', height: '17%', overflow: 'hidden' }}>
        ...
        {/* Fishing float ripple — centered at rabbit position */}
